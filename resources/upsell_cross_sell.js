...
window.UpsellCrossSellConfig = {
    checkout: {
        id: 'ucs-cart-cj-acessorio',
        title: '🛡️ Proteja suas cartinhas!',
        source: 'category',
        categoryId: '24115663',
    ...
    cart: {
        sections: [
            ...
            // Seção 1: compre junto de cada produto no carrinho
            {
                id: 'ucs-cart-cj',
                title: 'Combinam com o que você escolheu',
                source: 'compre_junto',
                sort: 'price_asc',       // 'most_sold' | 'price_asc' | 'price_desc'
                layout: 'slider',        // 'list' | 'grid' | 'slider'
                maxProducts: 5,
                slidesPerView: 5,
            ...
            // // Seção 2: mapa produto → recomendados com fixos primeiro
            // {
            //     id: 'ucs-cart-map',
            //     title: 'Combina com o que você escolheu',
            //     source: 'product_map',
            //     sort: 'most_sold',
            //     layout: 'slider',
            //     fixedProductIds: [],   // exibidos antes dos dinâmicos
            //     productMap: {
            //         '29003487': ['29119612', '63153681'],
            //         '63153681': ['29003487']
            //     },
            //     maxProducts: 6,
            ...
            // // Seção 3: categoria fixa (ex: lançamentos)
            // {
            //     id: 'ucs-cart-lancamentos',
            //     title: 'Novidades',
            //     source: 'category',
            //     sort: 'most_sold',
            //     layout: 'slider',
            ...
            // // Seção 4: somente produtos fixos (source: 'none')
            // {
            //     id: 'ucs-cart-fixed',
            //     title: 'Produtos especiais',
            //     source: 'none',         // 'none' = somente fixos; 'fixed' também aceito (alias)
            //     sort: 'most_sold',
            //     layout: 'slider',
            //     fixedProductIds: ['373398725'],
            //     maxProducts: 4,
            //     insertSelector: '.pagina-carrinho',
            //     insertMethod: 'beforeend'
            // }
...
(function () {
    ...
    const DEFAULT_CONFIG = {
        ...
        productPage: {
            ...
            // Fonte dos produtos: 'compre_junto' | 'category' | 'none'
            ...
            sections: [
                {
                    ...
                    // Fonte: 'compre_junto' | 'category' | 'product_map' | 'none'
        ...
        checkout: {
            ...
            // Fonte: 'lowest_related' | 'compre_junto' | 'category' | 'none'
